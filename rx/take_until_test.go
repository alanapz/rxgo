...
// 	cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s1", t: t, wg: &wg, source: source, expected: u.Of(1, 2)}))
// 	cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s2", t: t, wg: &wg, source: source, expected: u.Of(1, 2)}))
// 	cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s3", t: t, wg: &wg, source: source, expected: u.Of(1, 2)}))
...
// 		cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s1", t: t, wg: &wg, source: source, expected: u.Of(1, 2, 3, 4)}))
// 		cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s2", t: t, wg: &wg, source: source, expected: u.Of(1, 2, 3, 4)}))
// 		cleanup.Add(addTestSubscriber(testSubscriberArgs[int]{ctx: ctx, name: "s3", t: t, wg: &wg, source: source, expected: u.Of(1, 2, 3, 4)}))
